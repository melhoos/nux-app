...
const AboutWrapper = () => {
    return (
        <>
            ...
            <p>NUX er mest aktuelt for de som skal generere nye ideer og konsepter, sørge for relevant innhold, utarbeide skisser og prototyper, teste løsningene, ​se samspill med andre systemer​, kode løsningene frontend​.</p>
        </>
    )
}
